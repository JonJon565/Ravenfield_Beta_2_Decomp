...
Keywords { "DIRECTIONAL" "SHADOWS_SCREEN" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "VERTEXLIGHT_ON" }
					...
					//
					    ...
					    mad oT3.xy, r1.z, c15.zwzw, r1.xwzw
					    dp4 r0.z, c6, v0
					    mov oPos, r0
					    mov oT3.zw, r0
...
Keywords { "DIRECTIONAL" "SHADOWS_OFF" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					//
					    ...
					    cmp_pp r0.xyz, r0.w, r0, c3.x
					    mad_pp r0.xyz, c2, t2, r0
					    mov_pp r0.w, c3.y
					    mov_pp oC0, r0
...
Keywords { "DIRECTIONAL" "SHADOWS_OFF" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "FOG_EXP2" }
					...
					//
					    ...
					    dp3_pp r0.w, t0, c0
					    mul_pp r0.xyz, r0.w, r0
					    cmp_pp r0.xyz, r0.w, r0, c4.x
					    mad_pp r0.xyz, c3, t2, r0
					    mov_sat r0.w, t4.x
...
Keywords { "DIRECTIONAL" "SHADOWS_SCREEN" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "FOG_EXP2" }
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardAdd" "QUEUE"="Overlay+150" }
  ZTest Always
  ZWrite Off
  Blend One One
  GpuProgramID 73974
...
Keywords { "POINT" }
					...
					void main()
					{
					    u_xlat0.xyz = vs_TEXCOORD1.yyy * _LightMatrix0[1].xyz;
					    u_xlat0.xyz = _LightMatrix0[0].xyz * vs_TEXCOORD1.xxx + u_xlat0.xyz;
					    u_xlat0.xyz = _LightMatrix0[2].xyz * vs_TEXCOORD1.zzz + u_xlat0.xyz;
...
Keywords { "DIRECTIONAL_COOKIE" }
					...
					void main()
					{
					    u_xlat0.xy = vs_TEXCOORD1.yy * _LightMatrix0[1].xy;
					    u_xlat0.xy = _LightMatrix0[0].xy * vs_TEXCOORD1.xx + u_xlat0.xy;
					    u_xlat0.xy = _LightMatrix0[2].xy * vs_TEXCOORD1.zz + u_xlat0.xy;
...
Keywords { "DIRECTIONAL_COOKIE" "FOG_EXP2" }
 ...
 Pass {
  Name "PREPASS"
  Tags { "LIGHTMODE"="PrePassBase" "QUEUE"="Overlay+150" }
  ZTest Always
  GpuProgramID 145928
Program "vp" {
SubProgram "d3d9 " {
...
"ps_4_0_level_9_1
 ...
 Pass {
  Name "PREPASS"
  Tags { "LIGHTMODE"="PrePassFinal" "QUEUE"="Overlay+150" }
  ZTest Always
  ZWrite Off
  GpuProgramID 198584
Program "vp" {
...
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
					...
					//
					    ...
					    mad oT1.xy, r1.z, c11.zwzw, r1.xwzw
					    mul r1.xyz, v1.y, c8
					    ...
					    mov r3.z, r2.z
					    mov r3.y, r4.z
					    mad r2.xyz, r3, c21.x, c21.y
					    max r2.xyz, r2, c20.z
					    add r2.xyz, -r1, r2
					    mul r1.w, c19.w, c19.w
					    sge r1.w, -r1.w, r1.w
					    mad oT3.xyz, r1.w, r2, r1
					    dp4 r0.z, c2, v0
					    mov oPos, r0
					    mov oT1.zw, r0
					    mov oT2, c20.z
...
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "HDR_LIGHT_PREPASS_OFF" }
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = _Object2World[0].xyz * in_POSITION0.xxx + u_xlat1.xyz;
					    u_xlat1.xyz = _Object2World[2].xyz * in_POSITION0.zzz + u_xlat1.xyz;
					    vs_TEXCOORD0.xyz = _Object2World[3].xyz * in_POSITION0.www + u_xlat1.xyz;
					    u_xlat0.y = u_xlat0.y * _ProjectionParams.x;
					    u_xlat1.xzw = u_xlat0.xwy * vec3(0.5, 0.5, 0.5);
					    ...
					    u_xlat1.xyz = max(u_xlat1.xyz, vec3(0.0, 0.0, 0.0));
					    u_xlatb12 = unity_ColorSpaceLuminance.w==0.0;
					    vs_TEXCOORD3.xyz = (bool(u_xlatb12)) ? u_xlat1.xyz : u_xlat0.xyz;
					    return;
					}"
}
SubProgram "d3d11_9x " {
...
Keywords { "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "FOG_EXP2" "UNITY_HDR_ON" }
 ...
 Pass {
  Name "DEFERRED"
  Tags { "LIGHTMODE"="Deferred" "QUEUE"="Overlay+150" }
  ZTest Always
  GpuProgramID 282406
Program "vp" {
SubProgram "d3d9 " {
